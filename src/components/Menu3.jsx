...
import character5 from "./img/character5.png";
import character6 from "./img/character6.png";
import character7 from "./img/character7.png";
import character8 from "./img/character8.png";
import character9 from "./img/character9.png";
import character10 from "./img/character10.png";
import character11 from "./img/character11.png";
import character12 from "./img/character12.png";
    ...
    <div>
      ...
      <section id="varities" class="bg-danger bg-opacity-10">
        <div class="text-center py-5">
          <h4>
            <i class="bi bi-check-square me-2"></i>Cartoon/Character Cakes
          </h4>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character1} alt="Choco 1" />
              </div>
              <div>
      ...
      <div class="modal" id="enroll_2">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character2} alt="Choco 2" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
      ...
      <div class="modal" id="enroll_3">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character3} alt="Choco 3" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
      ...
      <div class="modal" id="enroll_4">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character4} alt="Choco 4" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
      ...
      <div class="modal" id="enroll_5">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character5} alt="Choco 5" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
      ...
      <div class="modal" id="enroll_6">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character6} alt="Choco 6" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
      ...
      <div class="modal" id="enroll_7">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character7} alt="Choco 7" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
      ...
      <div class="modal" id="enroll_8">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character8} alt="Choco 8" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
      ...
      <div class="modal" id="enroll_9">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character9} alt="Choco 9" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
      ...
      <div class="modal" id="enroll_10">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character10} alt="Choco 10" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
      ...
      <div class="modal" id="enroll_11">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character11} alt="Choco 11" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
      ...
      <div class="modal" id="enroll_11">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="modal-img d-flex justify-content-center">
                <img src={character12} alt="Choco 11" />
              </div>
              <div>
                <ul class="lead fs-6 mb-0">
                  <li>Prices may vary according to sizes.</li>
